...
- **Tráfego ADS-B/MLAT**: visualização externa ao vivo do `adsb.lol`, centrada no CIM. Não equivale à totalidade do tráfego e não é fonte oficial de separação ou autorização.
